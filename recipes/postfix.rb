...
#node.default['postfix']['main']['myhostname'] = "dev-listserv-1"

# TODO: Temporarily commenting out the mailman alias stuff
...
#node.default['postfix']['main']['mydestination'] = "dev-listserv-1.geo-comm.local, dev-listserv-1, localhost.localdomain, localhost"
#node.default['postfix']['main']['relayhost'] = "mail.geo-comm.com"
#node.default['postfix']['main']['mynetworks'] = "127.0.0.0/8 [::ffff:127.0.0.0]/104 [::1]/128"
...
#
#node.default['postfix']['main'][''] = ""
#node.default['postfix']['main'][''] = ""
#node.default['postfix']['main'][''] = ""


#node.default['postfix']['main']['use_alias_maps'] = true
#node.default['postfix']['main']['alias_maps'] = "hash:/etc/aliases,hash:/var/lib/mailman/data/aliases"
#node.default['postfix']['main']['alias_database'] = "hash:/etc/aliases,hash:/var/lib/mailman/data/aliases"
